...
class K8sOpMutatingOutput(
    NamedTuple(
        "_K8sOpMutatingOutput", [("k8s_config", UserDefinedDagsterK8sConfig), ("value", Any)]
    )
):
    value: Any
    ...
    def __new__(
        cls, k8s_config: UserDefinedDagsterK8sConfig | Mapping[str, Any], value: Any = None
    ):
        ...
        return super(K8sOpMutatingOutput, cls).__new__(cls, k8s_config, value)
